  ...
  <div>
    ...
    <div style="padding: 4px 0">
      ...
      <span style="float: right">
        ...
        <el-input v-model="valueTimeOne" style="width: 128px;margin-left: 5px"placeholder="请输入开始年月"  ></el-input>
<!--        <el-date-picker v-model="valueTimeOne" type="month" placeholder="选择月"></el-date-picker>-->
        <el-input v-model="valueTimeTwo" style="width: 128px;margin-left: 5px"placeholder="请输入结束年月"  ></el-input>
...
<!--            <el-date-picker v-model="valueTimeTwo" style="width: 184px;margin-left: 5px"  type="date" placeholder="选择结束时间" ></el-date-picker>-->
    ...
    <!--   借阅数据-->
    <el-dialog title="借阅数据" :visible.sync="dialogFormVisible" width="30%">
...
export default {
  ...
  methods: {
    ...
    search(){
      request.get("http://localhost:9090/ubookov/pasc",{
        params: {
          pageNum: this.pageNum,
          pageSize: this.pageSize,
          user: this.valueUser,
          bookname: this.valueBook,
          stat:this.valueStat,
          begintime:this.valueTimeOne,
          endtime: this.valueTimeTwo,
        }
      }).then(res =>{
        this.tableData=res.data
        this.total=res.total
